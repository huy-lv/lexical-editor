...
var fe = (e, u, t) => Bt(e, typeof u != "symbol" ? u + "" : u, t);
var bt = Object.create, Ve = Object.defineProperty, At = Object.getOwnPropertyDescriptor, wt = Object.getOwnPropertyNames, kt = Object.getPrototypeOf, St = Object.prototype.hasOwnProperty, Tu = (e) => {
  ...
  for (var t in u) Ve(e, t, { get: u[t], enumerable: !0 });
}, Nt = (e, u, t, r) => {
  if (u && typeof u == "object" || typeof u == "function") for (let n of wt(u)) !St.call(e, n) && n !== t && Ve(e, n, { get: () => u[n], enumerable: !(r = At(u, n)) || r.enumerable });
  return e;
}, Ot = (e, u, t) => (t = e != null ? bt(kt(e)) : {}, Nt(Ve(t, "default", { value: e, enumerable: !0 }), e)), _t = (e, u, t) => u.has(e) || Tu("Cannot " + t), jt = (e, u, t) => u.has(e) ? Tu("Cannot add the same private member more than once") : u instanceof WeakSet ? u.add(e) : u.set(e, t), De = (e, u, t) => (_t(e, u, "access private method"), t), Tt = xt((e) => {
...
var Q = "string", T = "array", q = "cursor", I = "indent", P = "align", $ = "trim", w = "group", O = "fill", k = "if-break", L = "indent-if-break", R = "line-suffix", W = "line-suffix-boundary", b = "line", _ = "label", S = "break-parent", Pu = /* @__PURE__ */ new Set([q, I, P, $, w, O, k, L, R, W, b, _, S]), zt = (e, u, t) => {
...
function Kt(e, u, t, r) {
  ...
  for (; n.length > 0; ) {
    ...
    let a = X(D);
    if (!a) throw new te(D);
    if ((u == null ? void 0 : u(D)) !== !1) switch (a) {
      case T:
      case O: {
        let i = a === T ? D : D.parts;
...
function Lu(e, u = {}) {
  return ir(u.expandedStates), { type: w, id: u.id, contents: e, break: !!u.shouldBreak, expandedStates: u.expandedStates };
}
function or(e) {
...
var pr = { type: W }, ye = { type: S }, hr = { type: $ }, Ge = { type: b, hard: !0 }, Ru = { type: b, hard: !0, literal: !0 }, Wu = { type: b }, Cr = { type: b, soft: !0 }, Y = [Ge, ye], Mu = [Ru, ye], K = { type: q };
function Vu(e, u) {
  let t = [];
...
function zu(e, u, t) {
  let r = e;
  if (u > 0) {
    for (let n = 0; n < Math.floor(u / t); ++n) r = me(r);
...
function Er(e) {
  ...
  function r(D, a, i) {
    ...
    if (D.type === b) {
      let c = ((o = i == null ? void 0 : i[a + 1]) == null ? void 0 : o.type) === S;
    ...
    if (D.type === S) return ((s = i == null ? void 0 : i[a - 1]) == null ? void 0 : s.type) === b && i[a - 1].hard ? void 0 : "breakParent";
...
function ve(e, u) {
  let t = {}, r = u.printWidth, n = qe(u.endOfLine), D = 0, a = [{ ind: qu(), mode: A, doc: e }], i = [], o = !1, s = [], c = 0;
  for (Qt(e); a.length > 0; ) {
...
`, n) : f;
      ...
      case q:
        ...
        break;
      case I:
        a.push({ ind: wr(l, u), mode: d, doc: f.contents });
        break;
      case P:
        a.push({ ind: kr(l, f.n, u), mode: d, doc: f.contents });
        break;
      case $:
        D -= $e(i);
        break;
      case w:
        switch (d) {
          ...
          case A: {
            ...
            if (!f.break && de(h, a, p, C, t)) a.push(h);
      ...
      case O: {
        ...
        if (E === 0) break;
        let m = C[p + 0], y = C[p + 1], g = { ind: l, mode: x, doc: m }, B = { ind: l, mode: A, doc: m }, M = de(g, [], h, s.length > 0, t, !0);
        if (E === 1) {
          M ? a.push(g) : a.push(B);
          break;
        }
        ...
        if (E === 2) {
          M ? a.push(ce, g) : a.push(we, B);
          break;
        }
        let yt = C[p + 2], ke = { ind: l, mode: d, doc: { ...f, [Ie]: p + 2 } };
        de({ ind: l, mode: x, doc: [m, y, yt] }, [], h, s.length > 0, t, !0) ? a.push(ke, ce, g) : M ? a.push(ke, we, g) : a.push(ke, we, B);
        break;
      }
      case k:
      case L: {
      ...
      case R:
        ...
        break;
      case W:
        s.length > 0 && a.push({ ind: l, mode: d, doc: Ge });
        break;
      case b:
        switch (d) {
          case x:
          ...
          case A:
            ...
            f.literal ? l.root ? (i.push(n, l.root.value), D = l.root.length) : (i.push(n), D = 0) : (D -= $e(i), i.push(n + l.value), D = l.length);
            break;
        }
        break;
      case _:
...
var Ke = Sr, J, Le, he, xr = class {
  ...
  findAncestor(e) {
    for (let u of De(this, J, he).call(this)) if (e(u)) return u;
  }
  hasAncestor(e) {
    for (let u of De(this, J, he).call(this)) if (e(u)) return !0;
    return !1;
  }
};
...
function* jr(e, u) {
  ...
  for (let r = 0; r < t.length; r++) {
    let n = t[r];
    for (let D of Be(n, u)) yield D, t.push(D);
  }
}
function Tr(e, u) {
...
var Rr = Lr, Hu = /* @__PURE__ */ new Set(["tokens", "comments", "parent", "enclosingNode", "precedingNode", "followingNode"]), Wr = (e) => Object.keys(e).filter((u) => !Hu.has(u));
function Mr(e) {
  return e ? (u) => e(u, Hu) : Wr;
}
var be = Mr;
function Vr(e) {
...
function Ze(e, u) {
  ...
  if (!r) return [];
  let i = ((t == null ? void 0 : t(e, u)) ?? [...Be(e, { getVisitorKeys: be(n) })]).flatMap((o) => r(o) ? [o] : Ze(o, u));
  return i.sort((o, s) => D(o) - D(s) || a(o) - a(s)), Se.set(e, i), i;
}
function Ku(e, u, t, r) {
  let { locStart: n, locEnd: D } = t, a = n(u), i = D(u), o = Ze(e, t), s, c, F = 0, l = o.length;
  for (; F < l; ) {
...
function zr(e, u) {
  let { comments: t } = e;
  if (delete e.comments, !Rr(t) || !u.printer.canAttachComment) return;
  let r = [], { printer: { experimentalFeatures: { avoidAstMutation: n = !1 } = {}, handleComments: D = {} }, originalText: a } = u, { ownLine: i = xe, endOfLine: o = xe, remaining: s = xe } = D, c = t.map((F, l) => ({ ...Ku(e, F, u), comment: F, text: a, options: u, ast: e, isLastComment: t.length - 1 === l }));
  for (let [F, l] of c.entries()) {
    ...
    if (n ? g = [l] : (d.enclosingNode = h, d.precedingNode = f, d.followingNode = p, g = [d, C, E, m, y]), qr(C, E, c, F)) d.placement = "ownLine", i(...g) || (p ? ie(p, d) : f ? oe(f, d) : G(h || m, d));
    else if (Ur(C, E, c, F)) d.placement = "endOfLine", o(...g) || (f ? oe(f, d) : p ? ie(p, d) : G(h || m, d));
    else if (d.placement = "remaining", !s(...g)) if (f && p) {
      let B = r.length;
      B > 0 && r[B - 1].followingNode !== p && iu(r, E), r.push(l);
    } else f ? oe(f, d) : p ? ie(p, d) : G(h || m, d);
  }
  if (iu(r, u), !n) for (let F of t) delete F.precedingNode, delete F.enclosingNode, delete F.followingNode;
}
var Yu = (e) => !/[\S\n\u2028\u2029]/u.test(e);
function qr(e, u, t, r) {
...
function iu(e, u) {
  ...
  for (o = n; o > 0; --o) {
    ...
    Re.strictEqual(c, D), Re.strictEqual(F, a);
...
function Kr(e, u) {
  ...
  return e.each(() => {
    ...
    o ? n.push(Gr(e, u)) : s && (a = Hr(e, u, a), D.push(a.doc));
...
function Xu({ plugins: e = [], showDeprecated: u = !1 } = {}) {
  ...
  for (let n of en(Object.assign({}, ...e.map(({ options: D }) => D), Qr))) !u && n.deprecated || (Array.isArray(n.choices) && (u || (n.choices = n.choices.filter((D) => !D.deprecated)), n.name === "parser" && (n.choices = [...n.choices, ...Xr(n.choices, t, e)])), n.pluginDefaults = Object.fromEntries(e.filter((D) => {
    var a;
...
var on = an, sn = (e) => String(e).split(/[/\\]/u).pop();
function Fu(e, u) {
  if (!u) return;
...
var fn = cn, ue = { key: (e) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e) ? e : JSON.stringify(e), value(e) {
  ...
  return r && D.push(Cu(e, u, r, t.descriptor)), n && D.push([Cu(e, u, n.title, t.descriptor)].concat(n.values.map((a) => rt(a, t.loggerPrintWidth))).join(`
...
function pn(e, u) {
  ...
  let a, i, o, s, c = 0, F = 0;
  for (; c < r; ) mu[c] = e.charCodeAt(D + c), Oe[c] = ++c;
  for (; F < n; ) for (a = u.charCodeAt(D + F), o = F++, i = F, c = 0; c < r; c++) s = a === mu[c] ? o : o + 1, o = Oe[c], i = Oe[c] = o > i ? s > i ? i + 1 : s : s > o ? o + 1 : s;
  return i;
}
var Dt = (e, u, { descriptor: t, logger: r, schemas: n }) => {
  let D = [`Ignored unknown option ${N.yellow(t.pair({ key: e, value: u }))}.`], a = Object.keys(n).sort().find((i) => pn(e, i) < 3);
...
function Cn(e, u) {
  ...
  for (let n of hn) n in u && (r[n] = mn(u[n], t, U.prototype[n].length));
  return r;
}
var U = class {
  static create(e) {
...
function at(e) {
  ...
  let { text: u, list: t } = e;
  return Nn((u || t) !== void 0, "Unexpected `expected` result, there should be at least one field."), t ? { text: u, list: { title: t.title, values: t.values.map(at) } } : { text: u };
}
function yu(e, u) {
...
function bu(e, u) {
  let t = We(typeof e == "object" && "redirect" in e ? e.redirect : e, u);
...
var On = class extends U {
  ...
  constructor(e, u) {
    let { logger: t = console, loggerPrintWidth: r = 80, descriptor: n = Tn, unknown: D = In, invalid: a = Pn, deprecated: i = $n, missing: o = () => !1, required: s = () => !1, preprocess: c = (l) => l, postprocess: F = () => Ce } = u || {};
    this._utils = { descriptor: n, logger: t || { warn: () => {
    } }, loggerPrintWidth: r, schemas: Bn(e, "name"), normalizeDefaultResult: gu, normalizeExpectedResult: at, normalizeDeprecatedResult: vu, normalizeForwardResult: We, normalizeRedirectResult: bu, normalizeValidateResult: yu }, this._unknownHandler = D, this._invalidHandler = xn(a), this._deprecatedHandler = i, this._identifyMissing = (l, d) => !(l in d) || o(l, d), this._identifyRequired = s, this._preprocess = c, this._postprocess = F, this.cleanHistory();
  }
  cleanHistory() {
  ...
  normalize(e) {
    ...
    for (let n of Object.keys(this._utils.schemas)) {
      ...
      if (!(n in u)) {
        let a = gu(D.default(this._utils));
    ...
    for (let n of Object.keys(this._utils.schemas)) {
      ...
      i !== Ce && (this._applyValidation(i, n, D), u[n] = i);
    }
  ...
  _applyNormalization(e, u) {
    ...
    for (let D of r) {
      ...
      let o = ({ from: F, to: l }) => {
        ...
        let d = vu(a.deprecated(F, this._utils), i, !0);
      ...
      We(a.forward(i, this._utils), i).forEach(o);
...
function Rn(e, u, { logger: t = !1, isCLI: r = !1, passThrough: n = !1, FlagSchema: D, descriptor: a } = {}) {
  if (r) {
  ...
  }, o = Wn(u, { isCLI: r, FlagSchema: D }), s = new Ln(o, { logger: t, unknown: i, descriptor: a }), c = t !== !1;
  c && _e && (s._hasDeprecationWarned = _e);
  let F = s.normalize(e);
  return c && (_e = s._hasDeprecationWarned), F;
}
function Wn(e, { isCLI: u, FlagSchema: t }) {
  let r = [];
  u && r.push(gn.create({ name: "_" }));
  for (let n of e) r.push(Mn(n, { isCLI: u, optionInfos: e, FlagSchema: t })), n.alias && u && r.push(En.create({ name: n.alias, sourceName: n.name }));
  return r;
}
function Mn(e, { isCLI: u, optionInfos: t, FlagSchema: r }) {
  let { name: n } = e, D = { name: n }, a, i = {};
  switch (e.type) {
    case "int":
      a = jn, u && (D.preprocess = Number);
      break;
    case "string":
      a = Au;
      break;
    case "choice":
      a = On, D.choices = e.choices.map((o) => o != null && o.redirect ? { ...o, redirect: { to: { key: e.name, value: o.redirect } } } : o);
      break;
    case "boolean":
      a = vn;
      break;
  ...
  return e.array ? yn.create({ ...u ? { preprocess: (o) => Array.isArray(o) ? o : [o] } : {}, ...i, valueSchema: a.create(D) }) : a.create({ ...D, ...i });
}
var Vn = Rn, zn = (e, u, t) => {
  if (!(e && u == null)) {
...
async function Jn(e, u = {}) {
  ...
  if (!r.parser) if (r.filepath) {
    if (r.parser = fn(r, { physicalFile: r.filepath }), !r.parser) throw new ou(`No parser could be inferred for file "${r.filepath}".`);
  } else throw new ou("No parser and no file path given, couldn't infer a parser.");
  let n = Xu({ plugins: e.plugins, showDeprecated: !0 }).options, D = { ...wu, ...Object.fromEntries(n.filter((l) => l.default !== void 0).map((l) => [l.name, l.default])) }, a = ot(r.plugins, r.parser), i = await st(a, r.parser);
  r.astFormat = i.astFormat, r.locEnd = i.locEnd, r.locStart = i.locStart;
  let o = (t = a.printers) != null && t[i.astFormat] ? a : qn(r.plugins, i.astFormat), s = await Un(o, i.astFormat);
  r.printer = s;
...
function ku(e, u, t, r, n) {
  ...
  switch ((D = i.hasPrettierIgnore) != null && D.call(i, e) ? o = Xn(e, u) : n.has(a) ? o = n.get(a) : o = i.print(e, u, t, r), a) {
    case u.cursorNode:
      o = pe(o, (s) => [K, s, K]);
      break;
  ...
  return i.printComment && (!i.willPrintOwnComments || !i.willPrintOwnComments(e, u)) && (o = Yr(e, o, u)), o;
}
...
function eD(e, u) {
  ...
  for (let d of jr(e, { getVisitorKeys: D, filter: a })) o.push(d), i = d;
  if (Tr(i, { getVisitorKeys: D })) return { cursorNode: i };
  let s, c, F = -1, l = Number.POSITIVE_INFINITY;
  for (; o.length > 0 && (s === void 0 || c === void 0); ) {
    i = o.pop();
    let d = s !== void 0, f = c !== void 0;
    for (let h of Be(i, { getVisitorKeys: D })) {
      if (!d) {
        let p = n(h);
        p <= t && p > F && (s = h, F = p);
      }
...
function iD(e, u, { locStart: t, locEnd: r }) {
  let n = e.node, D = u.node;
  if (n === D) return { startNode: n, endNode: D };
  let a = t(e.node);
  for (let o of Su(u.parentNodes)) if (t(o) >= a) D = o;
  else break;
  let i = r(u.node);
  for (let o of Su(e.parentNodes)) {
    if (r(o) <= i) n = o;
    else break;
    if (n === D) break;
  }
...
function xu(e, u, t) {
  ...
  switch (e.parser) {
    ...
    case "oxc-ts":
    case "__babel_estree":
      return oD(u.type, t == null ? void 0 : t.type);
    case "json":
    case "json5":
    case "jsonc":
    case "json-stringify":
...
function lD(e, u, t) {
  ...
  let s = Me(t, r, u, (d, f) => xu(u, d, f), [], "rangeStart"), c = o ? s : Me(t, n, u, (d) => xu(u, d), [], "rangeEnd");
  if (!s || !c) return { rangeStart: 0, rangeEnd: 0 };
  let F, l;
  if (DD(u)) {
    let d = aD(s, c);
    F = d, l = d;
  } else ({ startNode: F, endNode: l } = iD(s, c, u));
...
async function Ft(e, u, t = 0) {
  ...
  if (t > 0) {
    ...
    a.cursorNodeStart !== void 0 && (a.cursorNodeStart -= a.formatted.indexOf(o), a.cursorNodeStart < 0 && (a.cursorNodeStart = 0, a.cursorNodeText = a.cursorNodeText.trimStart()), a.cursorNodeStart + a.cursorNodeText.length > o.length && (a.cursorNodeText = a.cursorNodeText.trimEnd())), a.formatted = o + qe(u.endOfLine);
  }
  ...
  if (u.cursorOffset >= 0) {
    ...
    let d = s.split("");
    d.splice(l, 0, Nu);
    let f = F.split(""), h = Wt(d, f), p = c;
    for (let C of h) if (C.removed) {
      if (C.value.includes(Nu)) break;
    } else p += C.count;
...
async function cD(e, u) {
  let { ast: t, text: r } = await le(e, u), { rangeStart: n, rangeEnd: D } = lD(r, u, t), a = r.slice(n, D), i = Math.min(n, r.lastIndexOf(`
`, n) + 1), o = r.slice(i, n).match(/^\s*/u)[0], s = Ke(o, u.tabWidth), c = await Ft(a, { ...u, rangeStart: 0, rangeEnd: Number.POSITIVE_INFINITY, cursorOffset: u.cursorOffset > n && u.cursorOffset <= D ? u.cursorOffset - n : -1, endOfLine: "lf" }, s), F = c.formatted.trimEnd(), { cursorOffset: l } = u;
...
function pt(e, u) {
  let { cursorOffset: t, rangeStart: r, rangeEnd: n, endOfLine: D } = Ou(e, u), a = e.charAt(0) === dt;
  if (a && (e = e.slice(1), t--, r--, n--), D === "auto" && (D = Mt(e)), e.includes("\r")) {
    let i = (o) => Iu(e.slice(0, Math.max(o, 0)), `\r
`);
    t -= i(t), r -= i(r), n -= i(n), e = Vt(e);
  }
  return { hasBOM: a, text: e, options: Ou(e, { ...u, cursorOffset: t, rangeStart: r, rangeEnd: n, endOfLine: D }) };
}
...
async function ht(e, u) {
  ...
  if (n.rangeStart >= n.rangeEnd && r !== "" || n.requirePragma && !await _u(r, n) || n.checkIgnorePragma && await fD(r, n)) return { formatted: e, cursorOffset: u.cursorOffset, comments: [] };
  let D;
...
var mD = { join: Vu, line: Wu, softline: Cr, hardline: Y, literalline: Mu, group: Lu, conditionalGroup: cr, fill: fr, lineSuffix: Te, lineSuffixBoundary: pr, cursor: K, breakParent: ye, ifBreak: dr, trim: hr, indent: me, indentIfBreak: Fr, align: re, addAlignmentToDoc: zu, markAsRoot: sr, dedentToRoot: or, dedent: lr, hardlineWithoutBreakParent: Ge, literallineWithoutBreakParent: Ru, label: mr, concat: (e) => e }, ED = { printDocToString: ve }, gD = { willBreak: Zt, traverseDoc: Ue, findInDoc: Je, mapDoc: ge, removeLines: er, stripTrailingHardline: $u, replaceEndOfLine: rr, canBreak: Dr }, yD = "3.6.2", mt = {};
ze(mt, { addDanglingComment: () => G, addLeadingComment: () => ie, addTrailingComment: () => oe, getAlignmentSize: () => Ke, getIndentSize: () => kD, getMaxContinuousCount: () => ND, getNextNonSpaceNonCommentCharacter: () => _D, getNextNonSpaceNonCommentCharacterIndex: () => VD, getPreferredQuote: () => TD, getStringWidth: () => He, hasNewline: () => V, hasNewlineInRange: () => PD, hasSpaces: () => LD, isNextLineEmpty: () => JD, isNextLineEmptyAfterIndex: () => ru, isPreviousLineEmpty: () => qD, makeString: () => WD, skip: () => se, skipEverythingButNewLine: () => Gu, skipInlineComment: () => eu, skipNewline: () => Z, skipSpaces: () => z, skipToLineEnd: () => Ju, skipTrailingComment: () => uu, skipWhitespace: () => Ir });
function vD(e, u) {
  if (u === !1) return !1;
...
function bD(e, u) {
  let t = null, r = u;
  for (; r !== t; ) t = r, r = z(e, r), r = eu(e, r), r = uu(e, r), r = Z(e, r);
  return r;
}
var tu = bD;
function AD(e, u) {
  let t = null, r = u;
  for (; r !== t; ) t = r, r = Ju(e, r), r = eu(e, r), r = z(e, r);
...
var LD = $D;
function RD(e, u, t) {
  let r = u === '"' ? "'" : '"', n = Ee(!1, e, /\\(.)|(["'])/gsu, (D, a, i) => a === r ? a : i === u ? "\\" + i : i || (t && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/u.test(a) ? a : "\\" + a));
  return u + n + u;
}
var WD = RD;
function MD(e, u, t) {
...
function VD(e, u) {
  return arguments.length === 2 || typeof u == "number" ? tu(e, u) : MD(...arguments);
}
function zD(e, u, t) {
  return Qe(e, t(u));
}
