...
var ra = (ee, te, Z) => te in ee ? ta(ee, te, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : ee[te] = Z;
var Gt = (ee, te, Z) => ra(ee, typeof te != "symbol" ? te + "" : te, Z);
import { g as sa } from "./_commonjsHelpers-C6fGbg64.js";
function na(ee, te) {
  for (var Z = 0; Z < te.length; Z++) {
    const K = te[Z];
    if (typeof K != "string" && !Array.isArray(K)) {
      for (const re in K)
        if (re !== "default" && !(re in ee)) {
          const _e = Object.getOwnPropertyDescriptor(K, re);
          _e && Object.defineProperty(ee, re, _e.get ? _e : {
            enumerable: !0,
            get: () => K[re]
          });
        }
...
(function(ee, te) {
  (function(Z) {
    ...
    var Z = Object.create, K = Object.defineProperty, re = Object.getOwnPropertyDescriptor, _e = Object.getOwnPropertyNames, is = Object.getPrototypeOf, as = Object.prototype.hasOwnProperty, _ = (e, s) => () => (s || e((s = { exports: {} }).exports, s), s.exports), Jt = (e, s) => {
      for (var n in s) K(e, n, { get: s[n], enumerable: !0 });
    }, Qt = (e, s, n, o) => {
      if (s && typeof s == "object" || typeof s == "function") for (let c of _e(s)) !as.call(e, c) && c !== n && K(e, c, { get: () => s[c], enumerable: !(o = re(s, c)) || o.enumerable });
      return e;
    }, de = (e, s, n) => (n = e != null ? Z(is(e)) : {}, Qt(K(n, "default", { value: e, enumerable: !0 }), e)), us = (e) => Qt(K({}, "__esModule", { value: !0 }), e), ls = _((e, s) => {
...
`);
      ...
      var n = mt(), o = vt(), c = Ge(), { isClean: i, my: f } = yt();
      function u(r, t) {
...
` ? (t = 1, h += 1) : t += 1;
      ...
      var n = Ee(), o = Qe(), c = Je(), { isClean: i, my: f } = yt(), u, m, p, r;
      function t(d) {
      ...
      var a = class ss extends c {
        ...
        normalize(l, b) {
          ...
          return l.map((y) => (y[f] || ss.rebuild(y), y = y.proxyOf, y.parent && y.parent.removeChild(y), y[i] && h(y), y.raws || (y.raws = {}), typeof y.raws.before > "u" && b && typeof b.raws.before < "u" && (y.raws.before = b.raws.before.replace(/\S/g, "")), y.parent = this.proxyOf, y));
        }
        prepend(...l) {
          l = l.reverse();
          for (let b of l) {
      ...
      var { nanoid: n } = cs(), { isAbsolute: o, resolve: c } = {}, { SourceMapConsumer: i, SourceMapGenerator: f } = ps(), { fileURLToPath: u, pathToFileURL: m } = {}, p = mt(), r = Zt(), t = Ht(), h = Symbol("lineToIndexCache"), a = !!(i && f), d = !!(c && o);
      function l(y) {
        if (y[h]) return y[h];
        let v = y.css.split(`
`), g = new Array(v.length), k = 0;
      ...
      var b = class {
        ...
        error(y, v, g, k = {}) {
          ...
          return A ? E = new p(y, A.endLine === void 0 ? A.line : { column: A.column, line: A.line }, A.endLine === void 0 ? A.column : { column: A.endColumn, line: A.endLine }, A.source, A.file, k.plugin) : E = new p(y, x === void 0 ? v : { column: g, line: v }, x === void 0 ? g : { column: w, line: x }, this.css, this.file, k.plugin), E.input = { column: g, endColumn: w, endLine: x, endOffset: O, line: v, offset: T, source: this.css }, this.file && (m && (E.input.url = m(this.file).toString()), E.input.file = this.file), E;
        }
        ...
        origin(y, v, g, k) {
          ...
          let E = { column: x.column, endColumn: O && O.column, endLine: O && O.line, line: x.line, url: T.toString() };
          if (T.protocol === "file:") if (u) E.file = u(T);
          else throw new Error("file: protocol is not available in this PostCSS build");
          let A = w.sourceContentFor(x.source);
          return A && (E.source = A), E;
        }
        toJSON() {
          let y = {};
      ...
      var n = pe(), o, c, i = class extends n {
        constructor(f) {
...
`, "	"];
      ...
      var n = pe(), o = Kt(), c = class extends n {
        get selectors() {
      ...
      s.exports = function(f, u = {}) {
        ...
        function I(R) {
          ...
          switch (r = m.charCodeAt(w), r) {
            ...
            default: {
              r === 47 && m.charCodeAt(w + 1) === 42 ? (a = m.indexOf("*/", w + 2) + 1, a === 0 && (p || $ ? a = m.length : E("comment")), l = ["comment", m.slice(w, a + 1), w, a], w = a) : (o.lastIndex = w + 1, o.test(m), o.lastIndex === 0 ? a = m.length - 1 : a = o.lastIndex - 2, l = ["word", m.slice(w, a + 1), w, a], x.push(l), w = a);
              break;
            }
          }
          return w++, l;
      ...
      var n = gt(), o = Ee(), c = Qe(), i = je(), f = wt(), u = bt(), m = { empty: !0, space: !0 };
      function p(t) {
...
`));
      ...
      var n = Ee(), o = xt(), { isInlineComment: c } = fs(), { interpolation: i } = hs(), { isMixinToken: f } = ds(), u = ms(), m = vs(), p = /(!\s*important)$/i;
      s.exports = class extends o {
        ...
        mixin(r) {
          ...
          if ((a < 0 || a > 3) && d > 0) {
            let v = r.reduce((I, N, R) => N[0] === ")" ? R : I), g = r.slice(d, v + d).map((I) => I[1]).join(""), [k] = r.slice(d), w = [k[2], k[3]], [x] = r.slice(v, v + 1), O = [x[2], x[3]], T = ["brackets", g].concat(w, O), E = r.slice(0, d), A = r.slice(v + 1);
            r = E, r.push(T), r = r.concat(A);
          }
          let b = [];
      ...
      var n = gt(), o = Ee(), c = Qe(), i = Ae(), f = Zt(), u = je(), m = wt();
      function p(r, t) {
      ...
      var n = pe(), o = kt(), c = Xt(), i = He(), f = Ot(), u = je(), m = Ge(), { isClean: p, my: r } = yt();
      er();
      ...
      var g = {}, k = class ns {
        ...
        constructor(x, O, T) {
          ...
          let E;
          if (typeof O == "object" && O !== null && (O.type === "root" || O.type === "document")) E = v(O);
          else if (O instanceof ns || O instanceof f) E = v(O.root), O.map && (typeof T.map > "u" && (T.map = {}), T.map.inline || (T.map.inline = !1), T.map.prev = O.map);
          else {
            let A = i;
          ...
          this.result = new f(x, E, T), this.helpers = { ...g, postcss: g, result: this.result }, this.plugins = this.processor.plugins.map((A) => typeof A == "object" && A.prepare ? { ...A, ...A.prepare(this.result) } : A);
        }
        async() {
        ...
        prepareVisitors() {
          this.listeners = {};
          let x = (O, T, E) => {
            this.listeners[T] || (this.listeners[T] = []), this.listeners[T].push([O, E]);
          };
          for (let O of this.plugins) if (typeof O == "object") for (let T in O) {
            ...
            if (!a[T]) if (typeof O[T] == "object") for (let E in O[T]) E === "*" ? x(O, T, O[T][E]) : x(O, T + "-" + E.toLowerCase(), O[T][E]);
        ...
        async runAsync() {
          ...
          if (this.prepareVisitors(), this.hasListener) {
            ...
            if (this.listeners.OnceExit) for (let [O, T] of this.listeners.OnceExit) {
              ...
              try {
                if (x.type === "document") {
                  let E = x.nodes.map((A) => T(A, this.helpers));
                  await Promise.all(E);
        ...
        visitTick(x) {
          let O = x[x.length - 1], { node: T, visitors: E } = O;
          if (T.type !== "root" && T.type !== "document" && !T.parent) {
            x.pop();
            return;
          }
          if (E.length > 0 && O.visitorIndex < E.length) {
            let [I, N] = E[O.visitorIndex];
            O.visitorIndex += 1, O.visitorIndex === E.length && (O.visitors = [], O.visitorIndex = 0), this.result.lastPlugin = I;
            try {
        ...
        walkSync(x) {
          x[p] = !0;
          let O = b(x);
          for (let T of O) if (T === d) x.nodes && x.each((E) => {
            E[p] || this.walkSync(E);
          });
          else {
            let E = this.listeners[T];
            if (E && this.visitSync(E, x.toProxy())) return;
          }
        }
        warnings() {
      ...
      var n = kt(), o = tr(), c = xs(), i = je(), f = class {
        constructor(u = []) {
      ...
      var n = gt(), o = Ee(), c = pe(), i = mt(), f = Qe(), u = kt(), m = bs(), p = Ae(), r = tr(), t = Kt(), h = Je(), a = He(), d = ks(), l = Ot(), b = je(), y = wt(), v = Ge(), g = Yt();
      function k(...w) {
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`));
      ...
      var { Container: n } = Tt(), o = class extends n {
        constructor(c) {
      ...
      s.exports = function(u, m = {}) {
        ...
        return { back: $, endOfFile: I, nextToken: R, position: E };
      };
    }), Cs = _((e, s) => {
      var { Comment: n } = Tt(), o = xt(), c = Os(), i = Ts(), f = class extends o {
        atrule(u) {
          let m = u[1], p = u;
          for (; !this.tokenizer.endOfFile(); ) {
...
`)) break;
      ...
      var n = 39, o = 34, c = 92, i = 47, f = 10, u = 32, m = 12, p = 9, r = 13, t = 43, h = 62, a = 126, d = 124, l = 44, b = 40, y = 41, v = 91, g = 93, k = 59, w = 42, x = 58, O = 38, T = 64, E = /[ \n\t\r\{\(\)'"\\;/]/g, A = /[ \n\t\r\(\)\*:;@!&'"\+\|~>,\[\]\\]|\/(?=\*)/g;
      function I(N) {
        for (var R = [], $ = N.css.valueOf(), M = void 0, P = void 0, D = void 0, De = void 0, xe = void 0, ke = void 0, Oe = void 0, Te = void 0, Ce = void 0, B = void 0, Ue = void 0, Vt = $.length, j = -1, C = 1, S = 0, L = function(W, q) {
          ...
          switch (M = $.charCodeAt(S), M === f && (j = S, C += 1), M) {
            ...
            case o:
              D = M === n ? "'" : '"', P = S;
              do
                for (B = !1, P = $.indexOf(D, P + 1), P === -1 && L("quote", D), Ue = P; $.charCodeAt(Ue - 1) === c; ) Ue -= 1, B = !B;
              while (B);
              R.push(["string", $.slice(S, P + 1), C, S - j, C, P - j, S]), S = P;
              break;
            case T:
              E.lastIndex = S + 1, E.test($), E.lastIndex === 0 ? P = $.length - 1 : P = E.lastIndex - 2, R.push(["at-word", $.slice(S, P + 1), C, S - j, C, P - j, S]), S = P;
              break;
            case c:
              for (P = S, Oe = !0; $.charCodeAt(P + 1) === c; ) P += 1, Oe = !Oe;
              M = $.charCodeAt(P + 1), Oe && M !== i && M !== u && M !== f && M !== p && M !== r && M !== m && (P += 1), R.push(["word", $.slice(S, P + 1), C, S - j, C, P - j, S]), S = P;
              break;
            default:
              M === i && $.charCodeAt(S + 1) === w ? (P = $.indexOf("*/", S + 2) + 1, P === 0 && L("comment", "*/"), ke = $.slice(S, P + 1), De = ke.split(`
`), xe = De.length - 1, xe > 0 ? (Te = C + xe, Ce = P - De[xe].length) : (Te = C, Ce = j), R.push(["comment", ke, C, S - j, Te, P - Ce, S]), j = Ce, C = Te, S = P) : (A.lastIndex = S + 1, A.test($), A.lastIndex === 0 ? P = $.length - 1 : P = A.lastIndex - 2, R.push(["word", $.slice(S, P + 1), C, S - j, C, P - j, S]), S = P);
              break;
          }
          S++;
        }
      ...
      }(), o = nr(), c = B(o), i = or(), f = B(i), u = ir(), m = B(u), p = As(), r = B(p), t = js(), h = B(t), a = Is(), d = B(a), l = Ps(), b = B(l), y = Ms(), v = B(y), g = $s(), k = B(g), w = Rs(), x = B(w), O = Ns(), T = B(O), E = Ls(), A = B(E), I = Ws(), N = B(I), R = zs(), $ = B(R), M = Bs(), P = B(M), D = qs(), De = B(D), xe = Fs(), ke = B(xe), Oe = V(), Te = Ce(Oe);
      function Ce(j) {
      ...
      var Vt = function() {
        function j(C) {
          Ue(this, j), this.input = C, this.lossy = C.options.lossless === !1, this.position = 0, this.root = new r.default();
          var S = new h.default();
          return this.root.append(S), this.current = S, this.lossy ? this.tokens = (0, ke.default)({ safe: C.safe, css: C.css.trim() }) : this.tokens = (0, ke.default)(C), this.loop();
        }
        return j.prototype.attribute = function() {
          ...
          var W = C.split(/((?:[*~^$|]?=))([^]*)/), q = W[0].split(/(\|)/g), oe = { operator: W[1], value: W[2], source: { start: { line: L[2], column: L[3] }, end: { line: this.currToken[2], column: this.currToken[3] } }, sourceIndex: L[4] };
          if (q.length > 1 ? (q[0] === "" && (q[0] = !0), oe.attribute = this.parseValue(q[2]), oe.namespace = this.parseNamespace(q[0])) : oe.attribute = this.parseValue(W[0]), S = new A.default(oe), W[2]) {
            var ue = W[2].split(/(\s+i\s*?)$/), le = ue[0].trim();
            S.value = this.lossy ? le : ue[0], ue[1] && (S.insensitive = !0, this.lossy || (S.raws.insensitive = ue[1])), S.quoted = le[0] === "'" || le[0] === '"', S.raws.unquoted = S.quoted ? le.slice(1, -1) : le;
          }
          ...
          if (this.currToken[0] === "word") {
            var W = void 0;
            this.splitWord(!1, function(q, oe) {
              S += q, W = new T.default({ value: S, source: { start: { line: L[2], column: L[3] }, end: { line: C.currToken[4], column: C.currToken[5] } }, sourceIndex: L[4] }), C.newNode(W), oe > 1 && C.nextToken && C.nextToken[0] === "(" && C.error("Misplaced parenthesis.");
            });
          ...
          for (var L = this, W = this.nextToken, q = this.currToken[1]; W && W[0] === "word"; ) {
            this.position++;
            var oe = this.currToken[1];
            if (q += oe, oe.lastIndexOf("\\") === oe.length - 1) {
              var ue = this.nextToken;
              ue && ue[0] === "space" && (q += this.parseSpace(ue[1], " "), this.position++);
            }
            W = this.nextToken;
          }
          var le = (0, f.default)(q, "."), pt = (0, f.default)(q, "#"), es = (0, f.default)(q, "#{");
          es.length && (pt = pt.filter(function(ce) {
            return !~es.indexOf(ce);
          }));
          var Se = (0, De.default)((0, m.default)((0, c.default)([[0], le, pt])));
          Se.forEach(function(ce, Ve) {
            var ft = Se[Ve + 1] || q.length, ht = q.slice(ce, ft);
            if (Ve === 0 && S) return S.call(L, ht, Se.length);
            var dt = void 0;
            ~le.indexOf(ce) ? dt = new d.default({ value: ht.slice(1), source: { start: { line: L.currToken[2], column: L.currToken[3] + ce }, end: { line: L.currToken[4], column: L.currToken[3] + (ft - 1) } }, sourceIndex: L.currToken[6] + Se[Ve] }) : ~pt.indexOf(ce) ? dt = new v.default({ value: ht.slice(1), source: { start: { line: L.currToken[2], column: L.currToken[3] + ce }, end: { line: L.currToken[4], column: L.currToken[3] + (ft - 1) } }, sourceIndex: L.currToken[6] + Se[Ve] }) : dt = new k.default({ value: ht, source: { start: { line: L.currToken[2], column: L.currToken[3] + ce }, end: { line: L.currToken[4], column: L.currToken[3] + (ft - 1) } }, sourceIndex: L.currToken[6] + Se[Ve] }), L.newNode(dt, C);
          }), this.position++;
      ...
      e.default = Vt, s.exports = e.default;
    }), Us = _((e, s) => {
      e.__esModule = !0;
      var n = /* @__PURE__ */ function() {
        function m(p, r) {
...
` ? (i = 1, f += 1) : i += 1;
      ...
      var n = Q(), o = se(), c = class extends o {
        constructor(i) {
      ...
      var n = /[ \n\t\r\{\(\)'"\\;,/]/g, o = /[ \n\t\r\(\)\{\}\*:;@!&'"\+\|~>,\[\]\\]|\/(?=\*)/g, c = /[ \n\t\r\(\)\{\}\*:;@!&'"\-\+\|~>,\[\]\\]|\//g, i = /^[a-z0-9]/i, f = /^[a-f0-9?\-]/i, u = nn();
      s.exports = function(m, p) {
        p = p || {};
        let r = [], t = m.valueOf(), h = t.length, a = -1, d = 1, l = 0, b = 0, y = null, v, g, k, w, x, O, T, E, A, I, N;
        function R($) {
...
`), x = w.length - 1, x > 0 ? (T = d + x, E = g - w[x].length) : (T = d, E = a), r.push(["comment", O, d, l - a, T, g - E, l]), a = E, d = T, l = g;
      ...
      var n = Vs(), o = Gs(), c = Js(), i = Qs(), f = Hs(), u = Zs(), m = Ks(), p = Xs(), r = Ys(), t = en(), h = tn(), a = rn(), d = sn(), l = on(), b = nr(), y = or(), v = ir(), g = an();
      function k(w) {
      ...
      s.exports = class {
        ...
        parenOpen() {
          ...
          if (w && this.error("Expected closing parenthesis", O), T = this.current.last, T && T.type === "func" && T.unbalanced < 0 && (T.unbalanced = 0, this.current = T), this.current.unbalanced++, this.newNode(new t({ value: O[1], source: { start: { line: O[2], column: O[3] }, end: { line: O[4], column: O[5] } }, sourceIndex: O[6] })), this.position++, this.current.type === "func" && this.current.unbalanced && this.current.value === "url" && this.currToken[0] !== "string" && this.currToken[0] !== ")" && !this.options.loose) {
            let E = this.nextToken, A = this.currToken[1], I = { line: this.currToken[2], column: this.currToken[3] };
            for (; E && E[0] !== ")" && this.current.unbalanced; ) this.position++, A += this.currToken[1], E = this.nextToken;
        ...
        splitWord() {
          let w = this.nextToken, x = this.currToken[1], O = /^[\+\-]?((\d+(\.\d*)?)|(\.\d+))([eE][\+\-]?\d+)?/, T = /^(?!\#([a-z0-9]+))[\#\{\}]/gi, E, A;
          if (!T.test(x)) for (; w && w[0] === "word"; ) {
            this.position++;
            let I = this.currToken[1];
            x += I, w = this.nextToken;
          }
          E = y(x, "@"), A = k(v(b([[0], E]))), A.forEach((I, N) => {
            let R = A[N + 1] || x.length, $ = x.slice(I, R), M;
            if (~E.indexOf(I)) M = new c({ value: $.slice(1), source: { start: { line: this.currToken[2], column: this.currToken[3] + I }, end: { line: this.currToken[4], column: this.currToken[3] + (R - 1) } }, sourceIndex: this.currToken[6] + A[N] });
        ...
        string() {
          let w = this.currToken, x = this.currToken[1], O = /^(\"|\')/, T = O.test(x), E = "", A;
          T && (E = x.match(O)[0], x = x.slice(1, x.length - 1)), A = new h({ value: x, source: { start: { line: w[2], column: w[3] }, end: { line: w[4], column: w[5] } }, sourceIndex: w[6], quoted: T }), A.raws.quote = E, this.newNode(A), this.position++;
        }
        word() {
    ...
    Jt(ar, { languages: () => yi, options: () => bi, parsers: () => Vr, printers: () => ea });
    var ln = (e, s, n, o) => {
      if (!(e && s == null)) return s.replaceAll ? s.replaceAll(n, o) : n.global ? s.replace(n, o) : s.split(n).join(o);
    }, F = ln, ur = "string", lr = "array", cr = "cursor", Ze = "indent", St = "align", pr = "trim", Ke = "group", Xe = "fill", Ye = "if-break", fr = "indent-if-break", _t = "line-suffix", hr = "line-suffix-boundary", ve = "line", dr = "label", Et = "break-parent", mr = /* @__PURE__ */ new Set([cr, Ze, St, pr, Ke, Xe, Ye, fr, _t, hr, ve, dr, Et]), cn = (e, s, n) => {
    ...
    function pn(e) {
      ...
      if (!e) return;
      let { type: s } = e;
      if (mr.has(s)) return s;
    }
    var Pe = pn, fn = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
    function hn(e) {
...
Expected it to be ${o}.`;
    ...
    function yn(e) {
      return e.type === ve && !e.hard ? e.soft ? "" : " " : e.type === Ye ? e.flatContents : e;
    }
    function gn(e) {
      return vn(e, yn);
    }
    ...
    function vr(e, s) {
      return { type: St, contents: s, n: e };
    }
    function X(e, s = {}) {
      return bn(s.expandedStates), { type: Ke, id: s.id, contents: e, break: !!s.shouldBreak, expandedStates: s.expandedStates };
    }
    function xn(e) {
      return vr({ type: "root" }, e);
    }
    function Me(e) {
      return vr(-1, e);
    }
    function et(e) {
      return { type: Xe, parts: e };
    }
    function yr(e, s = "", n = {}) {
      return { type: Ye, breakContents: e, flatContents: s, groupId: n.groupId };
    }
    function kn(e) {
      return { type: _t, contents: e };
    }
    var At = { type: Et }, On = { type: ve, hard: !0 }, U = { type: ve }, Y = { type: ve, soft: !0 }, z = [On, At];
    function ie(e, s) {
      let n = [];
    ...
    var tt = Tn, gr = new Proxy(() => {
    }, { get: () => gr }), Cn = gr, rt = "'", wr = '"';
    function Sn(e, s) {
      let n = s === !0 || s === rt ? rt : wr, o = n === rt ? wr : rt, c = 0, i = 0;
    ...
    var An = En;
    function jn(e, s) {
      Cn.ok(/^(?<quote>["']).*\k<quote>$/su.test(e));
      let n = e.slice(1, -1), o = s.parser === "json" || s.parser === "jsonc" || s.parser === "json5" && s.quoteProps === "preserve" && !s.singleQuote ? '"' : s.__isInHtmlAttribute ? "'" : _n(n, s.singleQuote);
      return e.charAt(0) === o ? e : An(n, o, !1);
    }
    var br = jn, In = class extends Error {
      constructor(s, n, o = "type") {
        super(`Unexpected ${n} node ${o}: ${JSON.stringify(s[o])}.`);
    ...
    async function Ln(e, s) {
      if (e.language === "yaml") {
        ...
        return xn([e.startDelimiter, e.explicitLanguage, z, o, o ? z : "", e.endDelimiter]);
      }
    }
    var Wn = Ln;
    function kr(e) {
    ...
    kr.getVisitorKeys = (e) => e.type === "css-root" ? ["frontMatter"] : [];
    var zn = kr, $e = null;
    function Re(e) {
      if ($e !== null && typeof $e.property) {
        let s = $e;
        return $e = Re.prototype = null, s;
      }
      return $e = Re.prototype = e ?? /* @__PURE__ */ Object.create(null), new Re();
    }
    var Bn = 10;
    for (let e = 0; e <= Bn; e++) Re();
    function qn(e) {
      return Re(e);
    }
    function Fn(e, s = "type") {
      qn(e);
      function n(o) {
        let c = o[s], i = e[c];
    ...
    var Dn = Fn, Un = { "front-matter": [], "css-root": ["frontMatter", "nodes"], "css-comment": [], "css-rule": ["selector", "nodes"], "css-decl": ["value", "selector", "nodes"], "css-atrule": ["selector", "params", "value", "nodes"], "media-query-list": ["nodes"], "media-query": ["nodes"], "media-type": [], "media-feature-expression": ["nodes"], "media-feature": [], "media-colon": [], "media-value": [], "media-keyword": [], "media-url": [], "media-unknown": [], "selector-root": ["nodes"], "selector-selector": ["nodes"], "selector-comment": [], "selector-string": [], "selector-tag": [], "selector-id": [], "selector-class": [], "selector-attribute": [], "selector-combinator": ["nodes"], "selector-universal": [], "selector-pseudo": ["nodes"], "selector-nesting": [], "selector-unknown": [], "value-value": ["group"], "value-root": ["group"], "value-comment": [], "value-comma_group": ["groups"], "value-paren_group": ["open", "groups", "close"], "value-func": ["group"], "value-paren": [], "value-number": [], "value-operator": [], "value-word": [], "value-colon": [], "value-comma": [], "value-string": [], "value-atword": [], "value-unicode-range": [], "value-unknown": [] }, Vn = Un, Gn = Dn(Vn), Jn = Gn;
    function Qn(e, s) {
      let n = 0;
...
`, n) + 1;
    ...
    function _r(e, s) {
      ...
      if (typeof e.sourceIndex == "number") return e.type === "value-word" ? Sr(e, e.sourceIndex) : e.sourceIndex;
      if ((c = e.source) != null && c.start) return Or(e.source.start, s);
      throw Object.assign(new Error("Can not locate node."), { node: e });
    }
    function It(e, s) {
      var n, o;
      if (e.type === "css-comment" && e.inline) return Cr(s, e.source.startOffset);
      if (typeof ((o = (n = e.source) == null ? void 0 : n.end) == null ? void 0 : o.offset) == "number") return e.source.end.offset;
      if (e.source) {
        if (e.source.end) {
          let c = Or(e.source.end, s);
          return e.type === "value-word" ? Sr(e, c) : c;
        }
        if (tt(e.nodes)) return It(ye(!1, e.nodes, -1), s);
      }
      return null;
    }
    function Er(e, s) {
      e.source && (e.source.startOffset = _r(e, s), e.source.endOffset = It(e, s));
      for (let n in e) {
        let o = e[n];
        n === "source" || !o || typeof o != "object" || (o.type === "value-root" || o.type === "value-unknown" ? Ar(o, Zn(e), o.text || o.value) : Er(o, s));
      }
    }
    function Ar(e, s, n) {
      e.source && (e.source.startOffset = _r(e, n) + s, e.source.endOffset = It(e, n) + s);
      for (let o in e) {
        let c = e[o];
        o === "source" || !c || typeof c != "object" || Ar(c, s, n);
      }
    }
    function Zn(e) {
      var s;
...
` || u === "\r") && (c && i.push([o, f]), s = "initial", c = !1);
    ...
    function no(e) {
      let s = e.match(jr), n = s == null ? void 0 : s[0];
      return n == null ? e : e.slice(n.length);
    }
    function oo(e) {
      let s = `
`;
      e = F(!1, e.replace(Yn, "").replace(Xn, ""), ro, "$1");
      let n = "";
      for (; n !== e; ) n = e, e = F(!1, e, to, `${s}$1 $2${s}`);
      e = e.replace(Ir, "").trimEnd();
      let o = /* @__PURE__ */ Object.create(null), c = F(!1, e, Pr, "").replace(Ir, "").trimEnd(), i;
      for (; i = Pr.exec(e); ) {
        let f = F(!1, i[2], eo, "");
        if (typeof o[i[1]] == "string" || Array.isArray(o[i[1]])) {
          let u = o[i[1]];
          o[i[1]] = [...Mr, ...Array.isArray(u) ? u : [u], f];
        } else o[i[1]] = f;
      }
      return { comments: c, pragmas: o };
    }
    function io({ comments: e = "", pragmas: s = {} }) {
      let n = `
`, o = "/**", c = " *", i = " */", f = Object.keys(s), u = f.flatMap((p) => $r(p, s[p])).map((p) => `${c} ${p}${n}`).join("");
      if (!e) {
        if (f.length === 0) return "";
        if (f.length === 1 && !Array.isArray(s[f[0]])) {
          let p = s[f[0]];
          return `${o} ${$r(f[0], p)[0]}${i}`;
        }
      }
    ...
    function $r(e, s) {
      return [...Mr, ...Array.isArray(s) ? s : [s]].map((n) => `@${e} ${n}`.trim());
    }
    var ao = ["noformat", "noprettier"], uo = ["format", "prettier"], lo = "format";
    function co(e) {
...
`);
    ...
    function Pt(e) {
      ...
      let n = so(e), { pragmas: o, comments: c } = oo(n);
      return { shebang: s, text: e, pragmas: o, comments: c };
    }
    function fo(e) {
      let { pragmas: s } = Pt(e);
      return uo.some((n) => Object.prototype.hasOwnProperty.call(s, n));
    }
    function ho(e) {
      let { pragmas: s } = Pt(e);
      return ao.some((n) => Object.prototype.hasOwnProperty.call(s, n));
    }
    function mo(e) {
      let { shebang: s, text: n, pragmas: o, comments: c } = Pt(e), i = no(n), f = io({ pragmas: { [lo]: "", ...o }, comments: c.trimStart() });
      return (s ? `${s}
` : "") + f + (i.startsWith(`
`) ? `
` : `
...
`, Ne);
      if (n === -1) return;
      let o = e.slice(Ne, n).trim(), c = e.indexOf(`
${s}`, n), i = o;
      if (i || (i = s === "+++" ? "toml" : "yaml"), c === -1 && s === "---" && i === "yaml" && (c = e.indexOf(`
...`, n)), c === -1) return;
      let f = c + 1 + Ne, u = e.charAt(f + 1);
      if (!/\s?/u.test(u)) return;
      let m = e.slice(0, f);
      return { type: "front-matter", language: i, explicitLanguage: o, value: e.slice(n + 1, c), startDelimiter: s, endDelimiter: m.slice(-Ne), raw: m };
    }
    function yo(e) {
      let s = vo(e);
    ...
    var nt = yo;
    function go(e) {
      return fo(nt(e).content);
    }
    function wo(e) {
      return ho(nt(e).content);
    }
    function bo(e) {
      let { frontMatter: s, content: n } = nt(e);
      return (s ? s.raw + `

` : "") + mo(n);
    }
    var xo = /* @__PURE__ */ new Set(["red", "green", "blue", "alpha", "a", "rgb", "hue", "h", "saturation", "s", "lightness", "l", "whiteness", "w", "blackness", "b", "tint", "shade", "blend", "blenda", "contrast", "hsl", "hsla", "hwb", "hwba"]);
    function ko(e) {
      var s, n;
      return (n = (s = e.findAncestor((o) => o.type === "css-decl")) == null ? void 0 : s.prop) == null ? void 0 : n.toLowerCase();
    }
    var Oo = /* @__PURE__ */ new Set(["initial", "inherit", "unset", "revert"]);
    function To(e) {
      return Oo.has(e.toLowerCase());
    }
    function Co(e, s) {
      var n;
      let o = e.findAncestor((c) => c.type === "css-atrule");
      return ((n = o == null ? void 0 : o.name) == null ? void 0 : n.toLowerCase().endsWith("keyframes")) && ["from", "to"].includes(s.toLowerCase());
    }
    function Le(e) {
    ...
    function ot(e, s) {
      ...
      return ((n = o == null ? void 0 : o.value) == null ? void 0 : n.toLowerCase()) === s;
    }
    function So(e) {
      var s;
      let n = e.findAncestor((c) => c.type === "css-rule"), o = (s = n == null ? void 0 : n.raws) == null ? void 0 : s.selector;
    ...
    function $t(e) {
      return Mt(e) || it(e) || ae(e) || ge(e) || $o(e);
    }
    function Ro(e) {
    ...
    function Wt(e) {
      var s;
      return e.type === "value-paren_group" && ((s = e.groups) == null ? void 0 : s[0]) && Lt(e.groups[0]);
    }
    function Nr(e, s) {
      var n;
      ...
      let c = e.grandparent;
      if (!Wt(o) && !(c && Wt(c))) return !1;
      let i = e.findAncestor((f) => f.type === "css-decl");
      return !!((n = i == null ? void 0 : i.prop) != null && n.startsWith("$") || Wt(c) || c.type === "value-func");
    }
    function ze(e) {
    ...
    function Vo(e, s, n) {
      var o;
      let { node: c } = e, i = e.parent, f = e.grandparent, u = ko(e), m = u && i.type === "value-value" && (u === "grid" || u.startsWith("grid-template")), p = e.findAncestor((y) => y.type === "css-atrule"), r = p && Rt(p, s), t = c.groups.some((y) => ze(y)), h = e.map(n, "groups"), a = [""], d = ot(e, "url"), l = !1, b = !1;
      for (let y = 0; y < c.groups.length; ++y) {
        ...
        if (a.push([a.pop(), h[y]]), d) {
          (k && ae(k) || ae(g)) && a.push([a.pop(), " "]);
          continue;
        }
        if (ut(k) && g.type === "value-word" && a.length > 2 && c.groups.slice(0, y).every((I) => I.type === "value-comment") && !ze(v) && (a[a.length - 2] = Me(ye(!1, a, -2))), We(e, "forward") && g.type === "value-word" && g.value && v !== void 0 && v.type === "value-word" && v.value === "as" && k.type === "value-operator" && k.value === "*" || We(e, "utility") && g.type === "value-word" && k && k.type === "value-operator" && k.value === "*" || !k || g.type === "value-word" && lt(k) && J(g) === G(k)) continue;
        if (g.type === "value-string" && g.quoted) {
          let I = g.value.lastIndexOf("#{"), N = g.value.lastIndexOf("}");
          I !== -1 && N !== -1 ? l = I > N : I !== -1 ? l = !0 : N !== -1 && (l = !1);
        }
        if (l || ut(g) || ut(k) || g.type === "value-atword" && (g.value === "" || g.value.endsWith("[")) || k.type === "value-word" && k.value.startsWith("]") || g.value === "~" || g.type !== "value-string" && g.value && g.value.includes("\\") && k && k.type !== "value-comment" || v != null && v.value && v.value.indexOf("\\") === v.value.length - 1 && g.type === "value-operator" && g.value === "/" || g.value === "\\" || Wo(g, k) || zt(g) || Lr(g) || Bt(k) || Lr(k) && we(k) || Bt(g) && we(k) || g.value === "--" && zt(k)) continue;
        let x = $t(g), O = $t(k);
        if ((x && zt(k) || O && Bt(g)) && we(k) || !v && it(g) || ot(e, "calc") && (ae(g) || ae(k) || ge(g) || ge(k)) && we(k)) continue;
        let T = (ae(g) || ge(g)) && y === 0 && (k.type === "value-number" || k.isHex) && f && Do(f) && !we(k), E = (w == null ? void 0 : w.type) === "value-func" || w && at(w) || g.type === "value-func" || at(g), A = k.type === "value-func" || at(k) || (v == null ? void 0 : v.type) === "value-func" || v && at(v);
        if (s.parser === "scss" && x && g.value === "-" && k.type === "value-func" && J(g) !== G(k)) {
          a.push([a.pop(), " "]);
          continue;
        }
        if (!(!(Mt(k) || Mt(g)) && !ot(e, "calc") && !T && (it(k) && !E || it(g) && !A || ae(k) && !E || ae(g) && !A || ge(k) || ge(g)) && (we(k) || x && (!v || v && $t(v)))) && !((s.parser === "scss" || s.parser === "less") && x && g.value === "-" && ct(k) && J(g) === G(k.open) && k.open.value === "(")) {
          if (ze(g)) {
          ...
          if (m) {
            g.source && k.source && g.source.start.line !== k.source.start.line ? (a.push(z, ""), b = !0) : a.push([a.pop(), " "]);
            continue;
          }
          if (O) {
            a.push([a.pop(), " "]);
          ...
          if ((k == null ? void 0 : k.value) !== "..." && !(lt(g) && lt(k) && J(g) === G(k))) {
            if (lt(g) && ct(k) && J(g) === G(k.open)) {
              a.push(Y, "");
              continue;
            }
            if (g.value === "with" && ct(k)) {
              a = [[et(a), " "]];
              continue;
            }
            (o = g.value) != null && o.endsWith("#") && k.value === "{" && ct(k.group) || ze(k) && !w || a.push(U, "");
          }
        }
      }
      return t && a.push([a.pop(), At]), b && a.unshift("", z), r ? X(H(a)) : _o(e) ? X(et(a)) : X(H(et(a)));
    }
    var Go = Vo;
    function Jo(e) {
      return e.length === 1 ? e : e.toLowerCase().replace(/^([+-]?[\d.]+e)(?:\+|(-))?0*(?=\d)/u, "$1$2").replace(/^([+-]?[\d.]+)e[+-]?0+$/u, "$1").replace(/^([+-])?\./u, "$10.").replace(/(\.\d+?)0+(?=e|$)/u, "$1").replace(/\.(?=e|$)/u, "");
    }
    var Qo = Jo, qt = /* @__PURE__ */ new Map([["em", "em"], ["rem", "rem"], ["ex", "ex"], ["rex", "rex"], ["cap", "cap"], ["rcap", "rcap"], ["ch", "ch"], ["rch", "rch"], ["ic", "ic"], ["ric", "ric"], ["lh", "lh"], ["rlh", "rlh"], ["vw", "vw"], ["svw", "svw"], ["lvw", "lvw"], ["dvw", "dvw"], ["vh", "vh"], ["svh", "svh"], ["lvh", "lvh"], ["dvh", "dvh"], ["vi", "vi"], ["svi", "svi"], ["lvi", "lvi"], ["dvi", "dvi"], ["vb", "vb"], ["svb", "svb"], ["lvb", "lvb"], ["dvb", "dvb"], ["vmin", "vmin"], ["svmin", "svmin"], ["lvmin", "lvmin"], ["dvmin", "dvmin"], ["vmax", "vmax"], ["svmax", "svmax"], ["lvmax", "lvmax"], ["dvmax", "dvmax"], ["cm", "cm"], ["mm", "mm"], ["q", "Q"], ["in", "in"], ["pt", "pt"], ["pc", "pc"], ["px", "px"], ["deg", "deg"], ["grad", "grad"], ["rad", "rad"], ["turn", "turn"], ["s", "s"], ["ms", "ms"], ["hz", "Hz"], ["khz", "kHz"], ["dpi", "dpi"], ["dpcm", "dpcm"], ["dppx", "dppx"], ["x", "x"], ["cqw", "cqw"], ["cqh", "cqh"], ["cqi", "cqi"], ["cqb", "cqb"], ["cqmin", "cqmin"], ["cqmax", "cqmax"], ["fr", "fr"]]);
    function Wr(e) {
      let s = e.toLowerCase();
      return qt.has(s) ? qt.get(s) : e;
    }
    var zr = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu, Ho = /(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu, Zo = /[a-z]+/giu, Ko = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu, Xo = new RegExp(zr.source + `|(${Ko.source})?(${Ho.source})(${Zo.source})?`, "giu");
    function ne(e, s) {
      return F(!1, e, zr, (n) => br(n, s));
    }
    function Yo(e, s) {
      let n = s.singleQuote ? "'" : '"';
    ...
    function be(e) {
      return F(!1, e, Xo, (s, n, o, c, i) => !o && c && (i ?? (i = ""), i = i.toLowerCase(), !i || i === "n" || qt.has(i)) ? Br(c) + (i ? Wr(i) : "") : s);
    }
    function Br(e) {
      return Qo(e).replace(/\.0(?=$|e)/u, "");
    }
    function ei(e) {
...
` || c === "\r" || c === "\u2028" || c === "\u2029") return s + 1;
    ...
    var qr = ti;
    function ri(e, s, n = {}) {
      let o = Tr(e, n.backwards ? s - 1 : s, n), c = qr(e, o, n);
      return o !== c;
    }
    var Fr = ri;
    function si(e, s) {
    ...
    var ni = si;
    function oi(e, s) {
      return s === !1 ? !1 : e.charAt(s) === "/" && e.charAt(s + 1) === "/" ? Cr(e, s) : s;
    }
    var ii = oi;
    function ai(e, s) {
      let n = null, o = s;
      for (; o !== n; ) n = o, o = Hn(e, o), o = ni(e, o), o = Tr(e, o);
      return o = ii(e, o), o = qr(e, o), o !== !1 && Fr(e, o);
    }
    var Dr = ai;
    function ui({ node: e, parent: s }, n) {
      return !!(e.source && n.originalText.slice(G(e), G(s.close)).trimEnd().endsWith(","));
    }
    function li(e, s) {
      return Ao(e.grandparent) && ui(e, s) ? "," : e.node.type !== "value-comment" && !(e.node.type === "value-comma_group" && e.node.groups.every((n) => n.type === "value-comment")) && ei(s) && e.callParent(() => Nr(e, s)) ? yr(",") : "";
    }
    function ci(e, s, n) {
      let { node: o, parent: c } = e, i = e.map(({ node: a }) => typeof a == "string" ? a : n(), "groups");
      if (c && Eo(c) && (o.groups.length === 1 || o.groups.length > 0 && o.groups[0].type === "value-comma_group" && o.groups[0].groups.length > 0 && o.groups[0].groups[0].type === "value-word" && o.groups[0].groups[0].value.startsWith("data:"))) return [o.open ? n("open") : "", ie(",", i), o.close ? n("close") : ""];
      if (!o.open) {
        let a = Ur(e), d = fi(ie(",", i), 2), l = ie(a ? z : U, d);
        return H(a ? [z, l] : X([pi(e) ? Y : "", et(l)]));
      }
      let f = e.map(({ node: a, isLast: d, index: l }) => {
        var b;
        let y = i[l];
        Lt(a) && a.type === "value-comma_group" && a.groups && a.groups[0].type !== "value-paren_group" && ((b = a.groups[2]) == null ? void 0 : b.type) === "value-paren_group" && Pe(y) === Ke && Pe(y.contents) === Ze && Pe(y.contents.contents) === Xe && (y = X(Me(y)));
        let v = [y, d ? li(e, s) : ","];
        if (!d && a.type === "value-comma_group" && tt(a.groups)) {
          let g = ye(!1, a.groups, -1);
          !g.source && g.close && (g = g.close), g.source && Dr(s.originalText, J(g)) && v.push(z);
        }
        return v;
      }, "groups"), u = qo(o, c), m = Uo(o, c), p = Nr(e, s), r = m || p && !u, t = m || u, h = X([o.open ? n("open") : "", H([Y, ie(U, f)]), Y, o.close ? n("close") : ""], { shouldBreak: r });
      return t ? Me(h) : h;
    }
    function Ur(e) {
    ...
    function hi(e, s, n) {
      ...
      return e.each(() => {
        ...
        if ((i == null ? void 0 : i.type) === "css-comment" && i.text.trim() === "prettier-ignore" ? o.push(s.originalText.slice(G(c), J(c))) : o.push(n()), e.isLast) return;
        let { next: f } = e;
        f.type === "css-comment" && !Fr(s.originalText, G(f), { backwards: !0 }) && !st(c) || f.type === "css-atrule" && f.name === "else" && c.type !== "css-comment" ? o.push(" ") : (o.push(s.__isHTMLStyleAttribute ? U : z), Dr(s.originalText, J(c)) && !st(c) && o.push(z));
      }, "nodes"), o;
    }
    var qe = hi;
    function di(e, s, n) {
      ...
      switch (p.type) {
        case "front-matter":
          return [p.raw, z];
        case "css-root": {
          let r = qe(e, s, n), t = p.raws.after.trim();
          return t.startsWith(";") && (t = t.slice(1).trim()), [p.frontMatter ? [n("frontMatter"), z] : "", r, t ? ` ${t}` : "", p.nodes.length > 0 ? z : ""];
        }
        case "css-comment": {
          let r = p.inline || p.raws.inline, t = s.originalText.slice(G(p), J(p));
          return r ? t.trimEnd() : t;
        }
        case "css-rule":
          return [n("selector"), p.important ? " !important" : "", p.nodes ? [((o = p.selector) == null ? void 0 : o.type) === "selector-unknown" && Be(p.selector.value) ? U : p.selector ? " " : "", "{", p.nodes.length > 0 ? H([z, qe(e, s, n)]) : "", z, "}", jo(p) ? ";" : ""] : ";"];
        case "css-decl": {
          ...
          return l = zo(p) ? gn(l) : l, !a && Be(h) && !((i = (c = p.value) == null ? void 0 : c.group) != null && i.group && e.call(() => Ur(e), "value", "group", "group")) && (l = H([z, Me(l)])), [F(!1, p.raws.before, /[\s;]/gu, ""), r.type === "css-atrule" && r.variable || So(e) ? p.prop : Le(p.prop), h.startsWith("//") ? " " : "", h, p.extend || d ? "" : " ", s.parser === "less" && p.extend && p.selector ? ["extend(", n("selector"), ")"] : "", l, p.raws.important ? p.raws.important.replace(/\s*!\s*important/iu, " !important") : p.important ? " !important" : "", p.raws.scssDefault ? p.raws.scssDefault.replace(/\s*!default/iu, " !default") : p.scssDefault ? " !default" : "", p.raws.scssGlobal ? p.raws.scssGlobal.replace(/\s*!global/iu, " !global") : p.scssGlobal ? " !global" : "", p.nodes ? [" {", H([Y, qe(e, s, n)]), Y, "}"] : Lo(p) && !r.raws.semicolon && s.originalText[J(p) - 1] !== ";" ? "" : s.__isHTMLStyleAttribute && e.isLast ? yr(";") : ";"];
        }
        case "css-atrule": {
          let r = e.parent, t = Nt(p) && !r.raws.semicolon && s.originalText[J(p) - 1] !== ";";
          if (s.parser === "less") {
            ...
            if (p.variable) return ["@", p.name, ": ", p.value ? n("value") : "", p.raws.between.trim() ? p.raws.between.trim() + " " : "", p.nodes ? ["{", H([p.nodes.length > 0 ? Y : "", qe(e, s, n)]), Y, "}"] : "", t ? "" : ";"];
          }
          let h = p.name === "import" && ((f = p.params) == null ? void 0 : f.type) === "value-unknown" && p.params.value.endsWith(";");
          return ["@", Rr(p) || p.name.endsWith(":") || Nt(p) ? p.name : Le(p.name), p.params ? [Rr(p) ? "" : Nt(p) ? p.raws.afterName === "" ? "" : p.name.endsWith(":") ? " " : /^\s*\n\s*\n/u.test(p.raws.afterName) ? [z, z] : /^\s*\n/u.test(p.raws.afterName) ? z : " " : " ", typeof p.params == "string" ? p.params : n("params")] : "", p.selector ? H([" ", n("selector")]) : "", p.value ? X([" ", n("value"), Rt(p, s) ? Bo(p) ? " " : U : ""]) : p.name === "else" ? " " : "", p.nodes ? [Rt(p, s) ? "" : p.selector && !p.selector.nodes && typeof p.selector.value == "string" && Be(p.selector.value) || !p.selector && typeof p.params == "string" && Be(p.params) ? U : " ", "{", H([p.nodes.length > 0 ? Y : "", qe(e, s, n)]), Y, "}"] : t || h ? "" : ";"];
        }
        ...
        case "media-query":
          return [ie(" ", e.map(n, "nodes")), e.isLast ? "" : ","];
        case "media-type":
          return be(ne(p.value, s));
        case "media-feature-expression":
          return p.nodes ? ["(", ...e.map(n, "nodes"), ")"] : p.value;
        case "media-feature":
          return Le(ne(F(!1, p.value, / +/gu, " "), s));
        case "media-colon":
          return [p.value, " "];
        case "media-value":
          return be(ne(p.value, s));
        case "media-keyword":
          return ne(p.value, s);
        case "media-url":
          return ne(F(!1, F(!1, p.value, /^url\(\s+/giu, "url("), /\s+\)$/gu, ")"), s);
        case "media-unknown":
          return p.value;
        case "selector-root":
          return X([We(e, "custom-selector") ? [e.findAncestor((r) => r.type === "css-atrule").customSelector, U] : "", ie([",", We(e, ["extend", "custom-selector", "nest"]) ? U : z], e.map(n, "nodes"))]);
        case "selector-selector": {
          let r = p.nodes.length > 2;
          return X((r ? H : (t) => t)(e.map(n, "nodes")));
        }
        ...
        case "selector-string":
          return ne(p.value, s);
        case "selector-tag":
          return [p.namespace ? [p.namespace === !0 ? "" : p.namespace.trim(), "|"] : "", ((u = e.previous) == null ? void 0 : u.type) === "selector-nesting" ? p.value : be(Co(e, p.value) ? p.value.toLowerCase() : p.value)];
        case "selector-id":
          return ["#", p.value];
        case "selector-class":
          return [".", be(ne(p.value, s))];
        case "selector-attribute":
          return ["[", p.namespace ? [p.namespace === !0 ? "" : p.namespace.trim(), "|"] : "", p.attribute.trim(), p.operator ?? "", p.value ? Yo(ne(p.value.trim(), s), s) : "", p.insensitive ? " i" : "", "]"];
        case "selector-combinator": {
          if (p.value === "+" || p.value === ">" || p.value === "~" || p.value === ">>>") {
            let h = e.parent;
            return [h.type === "selector-selector" && h.nodes[0] === p ? "" : U, p.value, e.isLast ? "" : " "];
          }
          let r = p.value.trim().startsWith("(") ? U : "", t = be(ne(p.value.trim(), s)) || U;
          return [r, t];
        }
        case "selector-universal":
          return [p.namespace ? [p.namespace === !0 ? "" : p.namespace.trim(), "|"] : "", p.value];
        case "selector-pseudo":
          return [Le(p.value), tt(p.nodes) ? X(["(", H([Y, ie([",", U], e.map(n, "nodes"))]), Y, ")"]) : ""];
        case "selector-nesting":
          return p.value;
        case "selector-unknown": {
          let r = e.findAncestor((a) => a.type === "css-rule");
          if (r != null && r.isSCSSNesterProperty) return be(ne(Le(p.value), s));
          let t = e.parent;
          if ((m = t.raws) != null && m.selector) {
            let a = G(t), d = a + t.raws.selector.length;
            return s.originalText.slice(a, d).trim();
          }
          let h = e.grandparent;
          if (t.type === "value-paren_group" && (h == null ? void 0 : h.type) === "value-func" && h.value === "selector") {
            let a = J(t.open) + 1, d = G(t.close), l = s.originalText.slice(a, d).trim();
            return Be(l) ? [At, l] : l;
          }
          return p.value;
        }
        ...
        case "value-root":
          return n("group");
        case "value-comment":
          return s.originalText.slice(G(p), J(p));
        case "value-comma_group":
          return Go(e, s, n);
        case "value-paren_group":
          return ci(e, s, n);
        case "value-func":
          return [p.value, We(e, "supports") && Fo(p) ? " " : "", n("group")];
        case "value-paren":
          return p.value;
        case "value-number":
          return [Br(p.value), Wr(p.unit)];
        case "value-operator":
          return p.value;
        case "value-word":
          return p.isColor && p.isHex || To(p.value) ? p.value.toLowerCase() : p.value;
        case "value-colon": {
          let { previous: r } = e;
          return X([p.value, typeof (r == null ? void 0 : r.value) == "string" && r.value.endsWith("\\") || ot(e, "url") ? "" : U]);
        }
        case "value-string":
          return br(p.raws.quote + p.value + p.raws.quote, s);
        case "value-atword":
          return ["@", p.value];
        ...
        case "value-comma":
        default:
          throw new Pn(p, "PostCSS");
      }
    }
    var mi = { print: di, embed: zn, insertPragma: bo, massageAstNode: Nn, getVisitorKeys: Jn }, vi = mi, yi = [{ name: "CSS", type: "markup", extensions: [".css", ".wxss"], tmScope: "source.css", aceMode: "css", codemirrorMode: "css", codemirrorMimeType: "text/css", parsers: ["css"], vscodeLanguageIds: ["css"], linguistLanguageId: 50 }, { name: "PostCSS", type: "markup", extensions: [".pcss", ".postcss"], tmScope: "source.postcss", aceMode: "text", group: "CSS", parsers: ["css"], vscodeLanguageIds: ["postcss"], linguistLanguageId: 262764437 }, { name: "Less", type: "markup", extensions: [".less"], tmScope: "source.css.less", aceMode: "less", aliases: ["less-css"], codemirrorMode: "css", codemirrorMimeType: "text/css", parsers: ["less"], vscodeLanguageIds: ["less"], linguistLanguageId: 198 }, { name: "SCSS", type: "markup", extensions: [".scss"], tmScope: "source.css.scss", aceMode: "scss", codemirrorMode: "css", codemirrorMimeType: "text/x-scss", parsers: ["scss"], vscodeLanguageIds: ["scss"], linguistLanguageId: 329 }], gi = { singleQuote: { category: "Common", type: "boolean", default: !1, description: "Use single quotes instead of double quotes." } }, wi = { singleQuote: gi.singleQuote }, bi = wi, Vr = {};
    Jt(Vr, { css: () => Ki, less: () => Xi, scss: () => Yi });
    var xi = de(He()), ki = de(ws()), Oi = de(Ss());
    function Ti(e, s) {
    ...
    function Fe(e, s, n) {
      if (e && typeof e == "object") {
        delete e.parent;
        for (let o in e) Fe(e[o], s, n), o === "type" && typeof e[o] == "string" && !e[o].startsWith(s) && (!n || !n.test(e[o])) && (e[o] = s + e[o]);
      }
      return e;
    }
    function Gr(e) {
      if (e && typeof e == "object") {
        delete e.parent;
        for (let s in e) Gr(e[s]);
        !Array.isArray(e) && e.value && !e.type && (e.type = "unknown");
      }
      return e;
    }
    var _i = Si.default.default;
    function Ei(e) {
      let s;
      try {
        s = _i(e);
    ...
    function Ii(e) {
      ...
      return Fe(s, "selector-");
    }
    var fe = Ii, Pi = de(un()), Mi = (e) => {
      for (; e.parent; ) e = e.parent;
      return e;
    }, Jr = Mi;
    function $i(e) {
      return Jr(e).text.slice(e.group.open.sourceIndex + 1, e.group.close.sourceIndex).trim();
    }
    var Ri = $i;
    function Ni(e) {
      if (tt(e)) {
    ...
    var qi = Bi, Qr = (e) => e.type === "paren" && e.value === ")";
    function Fi(e, s) {
      var n;
      let { nodes: o } = e, c = { open: null, close: null, groups: [], type: "paren_group" }, i = [c], f = c, u = { groups: [], type: "comma_group" }, m = [u];
      for (let p = 0; p < o.length; ++p) {
        let r = o[p];
        if (s.parser === "scss" && r.type === "number" && r.unit === ".." && r.value.endsWith(".") && (r.value = r.value.slice(0, -1), r.unit = "..."), r.type === "func" && r.value === "selector" && (r.group.groups = [fe(Jr(e).text.slice(r.group.open.sourceIndex + 1, r.group.close.sourceIndex))]), r.type === "func" && r.value === "url") {
          let t = ((n = r.group) == null ? void 0 : n.groups) ?? [], h = [];
          for (let a = 0; a < t.length; a++) {
            let d = t[a];
            d.type === "comma_group" ? h = [...h, ...d.groups] : h.push(d);
          }
          (Li(h) || !zi(h) && !qi(h[0], s)) && (r.group.groups = [Ri(r)]);
        }
        if (r.type === "paren" && r.value === "(") c = { open: r, close: null, groups: [], type: "paren_group" }, i.push(c), u = { groups: [], type: "comma_group" }, m.push(u);
          ...
          m.pop(), u = ye(!1, m, -1), u.groups.push(c), i.pop(), c = ye(!1, i, -1);
        } else if (r.type === "comma") {
          if (p === o.length - 3 && o[p + 1].type === "comment" && Qr(o[p + 2])) continue;
    ...
    function Ft(e) {
      return e.type === "paren_group" && !e.open && !e.close && e.groups.length === 1 || e.type === "comma_group" && e.groups.length === 1 ? Ft(e.groups[0]) : e.type === "paren_group" || e.type === "comma_group" ? { ...e, groups: e.groups.map(Ft) } : e;
    }
    function Hr(e, s) {
      if (e && typeof e == "object") for (let n in e) n !== "parent" && (Hr(e[n], s), n === "nodes" && (e.group = Ft(Fi(e, s)), delete e[n]));
      return e;
    }
    function Di(e, s) {
      ...
      let n = null;
      try {
        n = new Pi.default(e, { loose: !0 }).parse();
      } catch {
        return { type: "value-unknown", value: e };
      }
      n.text = e;
      let o = Hr(n, s);
      return Fe(o, "value-", /^selector-/u);
    }
    var he = Di, Ui = /* @__PURE__ */ new Set(["import", "use", "forward"]);
    function Vi(e) {
      return Ui.has(e);
    }
    var Gi = Vi;
    ...
    var Qi = Ji, Hi = /(\s*)(!default).*$/u, Zi = /(\s*)(!global).*$/u;
    function Zr(e, s) {
      var n, o;
      if (e && typeof e == "object") {
        delete e.parent;
        for (let u in e) Zr(e[u], s);
        if (!e.type) return e;
        if (e.raws ?? (e.raws = {}), e.type === "css-decl" && typeof e.prop == "string" && e.prop.startsWith("--") && typeof e.value == "string" && e.value.startsWith("{")) {
          ...
          if (e.value.trimEnd().endsWith("}")) {
            ...
            s.parser === "scss" ? t = Yr : s.parser === "less" ? t = Xr : t = Kr;
            let h;
            try {
              h = t(r, { ...s });
            } catch {
            }
            ((n = h == null ? void 0 : h.nodes) == null ? void 0 : n.length) === 1 && h.nodes[0].type === "css-rule" && (u = h.nodes[0].nodes);
          }
        ...
        if (s.parser === "less" && e.type === "css-decl" && i.startsWith("extend(") && (e.extend || (e.extend = e.raws.between === ":"), e.extend && !e.selector && (delete e.value, e.selector = fe(i.slice(7, -1)))), e.type === "css-atrule") {
          if (s.parser === "less") {
            if (e.mixin) {
              let u = e.raws.identifier + e.name + e.raws.afterName + e.raws.params;
              return e.selector = fe(u), delete e.params, e;
            }
            if (e.function) return e;
          }
          if (s.parser === "css" && e.name === "custom-selector") {
            let u = e.params.match(/:--\S+\s+/u)[0].trim();
            return e.customSelector = u, e.selector = fe(e.params.slice(u.length).trim()), delete e.params, e;
          }
          if (s.parser === "less") {
            if (e.name.includes(":") && !e.params) {
              e.variable = !0;
              let u = e.name.split(":");
              e.name = u[0], e.value = he(u.slice(1).join(":"), s);
            }
            if (!["page", "nest", "keyframes"].includes(e.name) && ((o = e.params) == null ? void 0 : o[0]) === ":") {
              e.variable = !0;
              let u = e.params.slice(1);
              u && (e.value = he(u, s)), e.raws.afterName += ":";
            }
        ...
        if (e.type === "css-atrule" && f.length > 0) {
          ...
          return u === "warn" || u === "error" ? (e.params = { type: "media-unknown", value: f }, e) : u === "extend" || u === "nest" ? (e.selector = fe(f), delete e.params, e) : u === "at-root" ? (/^\(\s*(?:without|with)\s*:.+\)$/su.test(f) ? e.params = he(f, s) : (e.selector = fe(f), delete e.params), e) : Gi(m) ? (e.import = !0, delete e.filename, e.params = he(f, s), e) : ["namespace", "supports", "if", "else", "for", "each", "while", "debug", "mixin", "include", "function", "return", "define-mixin", "add-mixin"].includes(u) ? (f = f.replace(/(\$\S+?)(\s+)?\.{3}/u, "$1...$2"), f = f.replace(/^(?!if)(\S+)(\s+)\(/u, "$1($2"), e.value = he(f, s), delete e.params, e) : ["media", "custom-media"].includes(m) ? f.includes("#{") ? { type: "media-unknown", value: f } : (e.params = Ai(f), e) : (e.params = f, e);
        }
      }
      return e;
    }
    function Dt(e, s, n) {
      let o = nt(s), { frontMatter: c } = o;
      s = o.content;
      let i;
      try {
        i = e(s, { map: !1 });
        ...
        throw typeof p != "number" ? f : Ci(`${u}: ${m}`, { loc: { start: { line: p, column: r } }, cause: f });
      }
      return n.originalText = s, i = Zr(Fe(i, "css-"), n), Er(i, s), c && (c.source = { startOffset: 0, endOffset: c.raw.length }, i.frontMatter = c), i;
    }
    function Kr(e, s = {}) {
      return Dt(xi.default.default, e, s);
    }
    function Xr(e, s = {}) {
      return Dt((n) => ki.default.parse(Kn(n)), e, s);
    }
    function Yr(e, s = {}) {
      return Dt(Oi.default, e, s);
    }
    var Ut = { astFormat: "postcss", hasPragma: go, hasIgnorePragma: wo, locStart: G, locEnd: J }, Ki = { ...Ut, parse: Kr }, Xi = { ...Ut, parse: Xr }, Yi = { ...Ut, parse: Yr }, ea = { postcss: vi };
    return us(ar);
  });
})(ts);
var os = ts.exports;
const oa = /* @__PURE__ */ sa(os), ua = /* @__PURE__ */ na({
  __proto__: null,
  default: oa
}, [os]);
export {
